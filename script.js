...
//already created in the CSS (thanks guys)
var saveThis = $(".saveBtn")

//start with moment doc.

var timeTime = moment().format("dddd MMMM Do");
$("#currentDay").text(timeTime);
...
$("#19 textarea").val(localStorage.getItem("19").replace([""]+g, ""));
$("#20 textarea").val(localStorage.getItem("20").replace([""]+g, ""));
$("#21 textarea").val(localStorage.getItem("21").replace([""]+g, ""));
$("#22 textarea").val(localStorage.getItem("22").replace([""]+g, ""));